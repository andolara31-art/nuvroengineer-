...
export default function Contact() {
  ...
  return (
    <section id="contacto" className="py-24 md:py-32 bg-[#000000] relative border-t border-white/5 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-24 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="mt-auto pt-8 w-full border-t border-white/5">
              <a 
                href="#express" 
                className="w-full py-4 rounded-xl flex items-center justify-center gap-2 bg-white/5 text-white font-bold uppercase tracking-wider text-sm hover:bg-white hover:text-black transition-colors"
               >
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="bg-gradient-to-br from-[#0066FF]/10 to-transparent border border-[#0066FF]/20 p-8 md:p-12 rounded-[40px] flex flex-col items-start relative group shadow-2xl"
          >
            ...
            <div className="mt-auto pt-8 w-full border-t border-white/10">
              <a 
                href="#formulario" 
                className="w-full py-4 rounded-xl flex items-center justify-center gap-2 bg-[#0066FF] text-white font-bold uppercase tracking-wider text-sm hover:bg-[#0052cc] transition-colors shadow-lg shadow-[#0066FF]/20"
               >
        ...
        <div id="formulario" className="max-w-3xl mx-auto scroll-mt-32">
          <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-[#050505] border border-white/10 rounded-[40px] p-8 md:p-12 shadow-2xl"
          >
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input type="text" className="w-full bg-[#111] border border-white/5 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-white/20 focus:bg-[#151515] transition-all placeholder:text-white/20" placeholder="Ej. Carlos Mendoza" required />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold text-white/50 uppercase tracking-widest pl-2">Negocio</label>
                  <input type="text" className="w-full bg-[#111] border border-white/5 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-white/20 focus:bg-[#151515] transition-all placeholder:text-white/20" placeholder="Ej. Cafeoteca" required />
                </div>
              </div>

              <div className="space-y-2">
                <label className="text-xs font-bold text-white/50 uppercase tracking-widest pl-2">WhatsApp</label>
                <input type="tel" className="w-full bg-[#111] border border-white/5 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-white/20 focus:bg-[#151515] transition-all placeholder:text-white/20" placeholder="+506 8888 8888" required />
              </div>

              <div className="space-y-2">
                <label className="text-xs font-bold text-white/50 uppercase tracking-widest pl-2">¿Qué necesitás?</label>
                <textarea rows={4} className="w-full bg-[#111] border border-white/5 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-white/20 focus:bg-[#151515] transition-all resize-none placeholder:text-white/20" placeholder="Hablame un poco sobre lo que tenés en mente..." required></textarea>
              </div>

              <div className="pt-4 flex flex-col sm:flex-row gap-4">
                <button type="submit" className="flex-1 bg-[#0066FF] text-white py-5 rounded-2xl font-bold uppercase tracking-widest text-sm hover:bg-[#0052cc] transition-all flex items-center justify-center gap-3">
                  Enviar proyecto <ArrowUpRight size={18} />
                </button>
                <a href={whatsappUrl} target="_blank" rel="noreferrer" className="flex-1 bg-white/5 border border-white/10 text-white py-5 rounded-2xl font-bold uppercase tracking-widest text-sm hover:bg-white/10 transition-all flex items-center justify-center gap-3">
