      ...
      <div className={`max-w-7xl mx-auto px-5 md:px-8 flex items-center justify-between transition-all duration-300 ${
        ...
        <a href="/" className="flex items-center gap-4 group">
          ...
          <div className="flex flex-col leading-none">
            ...
            <span className="text-[11px] md:text-xs text-[#0066FF] uppercase tracking-[0.36em] font-extrabold">Engineer</span>
          </div>
        </a>
          ...
          >
            <div className="bg-[#0A0A0A] border border-white/10 p-6 flex flex-col gap-4 shadow-2xl">
              ...
              <a
                href="#contacto"
                onClick={() => setMobileMenuOpen(false)}
                className="mt-4 w-full py-4 bg-[#0066FF] text-white text-sm font-bold uppercase tracking-wider text-center"
              >
                Iniciar Proyecto
              </a>
            </div>
